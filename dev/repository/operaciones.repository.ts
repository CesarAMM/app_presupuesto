...
export default class OperacionRepository {
  ...
  static async insert_operacion (
      VLTOperacion: string, 
      VLCategoria: string, 
      VLSubcategoria: string, 
      VLCuenta: string, 
      VLMonto: number,
      VLFecha: string, 
      VLTCategoria: string,
      VLResponsable: string) {
  ...
  static async insert_det_operacion(VTOperacion: number, VTCodigo: number, VTDescripcion: string, VTMedida: string, VTCantidad: string, VTMonto: number){
    try{
